...
class CommandManager
{
    ...
    Start()
    {
        ...
        // ["name", ["aliases"], "description", "usage", ["examples"], "file"]
        //    0          1            2            3          4          5
        var includeList = this.RektOS.Config.CommandManager.IncludeList;
{"help", {}, "Displays help", "", {}, "help.js"}
        for (var i = 0; i < includeList.length; i++)
        {
            this.RegisterCommand(includeList[i][0], // name
                                 includeList[i][1], // aliases
                                 includeList[i][2], // description
                                 includeList[i][3], // usage
                                 includeList[i][4], // examples
                                 require("./commands/" + includeList[i][5]));
        }
